...
<div class="container">
  ...
  <hr/>
    ...
    <c:if test="${sLevel == 0}">
	    <a href="${ctp}/admin/guestList" class="btn btn-info">관리자(방명록)</a>
	    <a href="${ctp}/admin/boardList" class="btn btn-info">관리자(게시판)</a>
	    <a href="${ctp}/admin/pdsList" class="btn btn-info">관리자(자료실)</a>
    </c:if>
